...
for category_json in loan_data:
    ...
    for loan_json in loan_data_list:
        print(loan_json)
        loan = create_loan(loan_json["loan_name"], loan_json["loan_description"], loan_json["loan_website"], loan_json["loan_gov"], loan_json["loan_region"], loan_json["loan_city"], loan_json["loan_credit_union"], category.category_loans_id)
